...
@section('title', __('menu.Brands'))

@section('page-header')
<x-page-header 
    :pageTitle="__('menu.Brands')" 
    :currentPageTitle="__('menu.Brands')"
    :haveSearch="true" 
    :linkCache="false" 
    :haveCalendarSearch="false" 
    :pagesBreadcrumb="[]"
    :routePageCreate="route('brand.create')" 
    :routeNamePageCreate="__('partials.Create')" 
    dataMethodCreate="brand.create" 
/>
@endsection
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{__('brand::language.field.name')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$row->name}}</td>
                                            <td>
                                                <x-edit :href="route('brand.edit',[$row->id])" data-method="brand.edit" />
                                                <x-delete :href="route('brand.destroy',[$row->id])" data-method="brand.destroy" />
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <form action="" method="GET">
                    <div class="modal-body">
                        <fieldset class="form-group control-group floating-label-form-group control-group">
                            <label for="name">{{__('brand::language.field.name')}}</label>
                            <input type="text" name="name" value="{{request()->name}}" class="form-control" id="name"
                                placeholder="{{__('brand::language.field.pleaseEnterName')}}">
                        </fieldset>
                    </div>
