...
@section('title', __('menu.Companies'))

@section('page-header')
<x-page-header 
    :pageTitle="__('menu.Companies')" 
    :currentPageTitle="__('menu.Companies')"
    :haveSearch="true" 
    :linkCache="false" 
    :haveCalendarSearch="false" 
    :pagesBreadcrumb="[]"
    :routePageCreate="route('company.create')" 
    :routeNamePageCreate="__('partials.Create')" 
    dataMethodCreate="company.create" 
/>
@endsection
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{__('company::language.field.logo')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$row->name}}</td>
                                            <td><img src="{{$row->logo_url}}" width="100"></td>
                                            <td>
                                                <x-edit :href="route('company.edit',[$row->id])" data-method="company.edit" />
                                                <x-delete :href="route('company.destroy',[$row->id])"
                                                    data-method="company.destroy" />
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
