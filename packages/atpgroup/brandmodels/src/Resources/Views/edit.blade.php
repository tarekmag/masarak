...
<x-page-header 
    ...
    :pagesBreadcrumb="[['title'=> __('menu.BrandModels'), 'link'=> route('brandModel.index')]]" 
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{route('brandModel.update', [$brandModel->id])}}" method="POST" novalidate>
                                @method('PUT')
                                @include('brandModel::form')
                            </form>
