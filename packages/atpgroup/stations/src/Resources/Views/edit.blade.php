...
@section('page-header')
<x-page-header 
    :pageTitle="__('menu.Stations')" 
    :currentPageTitle="__('partials.Update')" 
    :haveSearch="false"
    :linkCache="false"
    :haveCalendarSearch="false" 
    :pagesBreadcrumb="[['title'=> __('menu.Stations'), 'link'=> route('station.index')]]" 
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{route('station.update', [$station->id])}}" method="POST" novalidate>
                                @method('PUT')
