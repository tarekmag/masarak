...
@section('page-header')
    <x-page-header :pageTitle="__('menu.PricingLists')" :currentPageTitle="__('partials.Create')" :haveSearch="false" :linkCache="false" :haveCalendarSearch="false"
