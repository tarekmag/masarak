...
<x-page-header
    ...
    :currentPageTitle="__('menu.Branches')"
    :haveSearch="true"
    :linkCache="false"
    :haveCalendarSearch="false"
    :pagesBreadcrumb="[]"
    :routePageCreate="route('branch.create')"
    :routeNamePageCreate="__('partials.Create')"
    dataMethodCreate="branch.create"
/>
@endsection
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{__('company::language.field.company')}}</th>
                                            <th>{{__('company::language.field.name')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{optional($row->parentCompany)->name}}</td>
                                            <td>{{$row->name}}</td>
                                            <td>
                                                <x-edit :href="route('branch.edit',[$row->id])" data-method="branch.edit" />
                                                <x-delete :href="route('branch.destroy',[$row->id])"
                                                    data-method="branch.destroy" />
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <form action="" method="GET">
                    <div class="modal-body">
                        <fieldset class="form-group control-group floating-label-form-group control-group">
                            <x-company-dropdown-company :companyId="request()->parent_id" :required="false" name="parent_id" />
                        </fieldset>
                        <br>
                        <fieldset class="form-group control-group floating-label-form-group control-group">
                            <label for="name">{{__('company::language.field.name')}}</label>
                            <input type="text" name="name" value="{{request()->name}}" class="form-control" id="name"
                                placeholder="{{__('company::language.field.pleaseEnterName')}}">
                        </fieldset>
                        <br>
                    </div>
