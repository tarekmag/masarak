...
<x-page-header 
    ...
    :pagesBreadcrumb="[]"
    :routePageCreate="route('district.create')" 
    :routeNamePageCreate="__('partials.Create')" 
    dataMethodCreate="district.create" 
/>
@endsection
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{__('district::language.field.name')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$row->name}}</td>
                                            <td>
                                                <x-edit :href="route('district.edit',[$row->id])" data-method="district.edit" />
                                                <x-delete :href="route('district.destroy',[$row->id])" data-method="district.destroy" />
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <form action="" method="GET">
                    <div class="modal-body">
                        <fieldset class="form-group control-group floating-label-form-group control-group">
                            <label for="name">{{__('district::language.field.name')}}</label>
                            <input type="text" name="name" value="{{request()->name}}" class="form-control" id="name"
                                placeholder="{{__('district::language.field.pleaseEnterName')}}">
                        </fieldset>
                        <br>
                    </div>
