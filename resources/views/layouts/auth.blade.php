...
<body class="vertical-layout vertical-menu 1-column menu-expanded fixed-navbar" data-open="click"
  ...
  <nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-dark navbar-shadow" style="background-color: #6bc1c5">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="{{ route('login') }}">
                ...
                src="{{ asset('images/Transic_Logo_White.svg') }}" style="width:170px; margin-top: -7px;">
              {{-- <h3 class="brand-text">{{__('partials.AppName')}}</h3> --}}
            </a>
          </li>
