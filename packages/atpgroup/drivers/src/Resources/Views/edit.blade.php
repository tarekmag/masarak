...
@section('page-header')
<x-page-header 
    :pageTitle="__('menu.Drivers')" 
    :currentPageTitle="__('partials.Update')" 
    :haveSearch="false"
    :linkCache="false"
    :haveCalendarSearch="false" 
    :pagesBreadcrumb="[['title'=> __('menu.Drivers'), 'link'=> route('driver.index')]]" 
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" action="{{route('driver.update', [$driver->id])}}" method="POST" novalidate>
                                @method('PUT')
                                @include('driver::form')
                            </form>
                        </div>
