            ...
            <tr style="height:700px;">
                ...
                <td style="width: 67%;" valign="top"><br><br><br>
                    <h2
                        ...
                        Hello! Reset Password Notification</h2>
                    <h3
                        ...
                        Thank you for contacting clinic gulf app.</h3><br>
                    <p
                        style="color:#333; font-weight: 400; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'; font-size:18px;margin:0;">
                        Please click the link below to reset your password. <a href="{{$url}}">Reset password link </a> Reset password link will expire in {{$expiryCount}} minutes.<br>
                    </p><br>

                    <p
                        style="color:#333; font-weight: 400; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'; font-size:18px;margin:0;">
                        Thank you for choosing clinic gulf app.</p><br>
