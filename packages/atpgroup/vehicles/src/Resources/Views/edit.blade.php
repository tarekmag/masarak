...
@section('page-header')
    <x-page-header :pageTitle="__('menu.Vehicles')" :currentPageTitle="__('partials.Update')" :haveSearch="false" :linkCache="false" :haveCalendarSearch="false"
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('vehicle.update', [$vehicle->id]) }}" method="POST"
                                    novalidate>
                                    @method('PUT')
